...
enum Securegcm_AppleDeviceDiagonalMils: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
...
enum Securegcm_DeviceType: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
  case unknown = 0
  case android = 1
  case chrome = 2
  case ios = 3
...
enum Securegcm_SoftwareFeature: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
...
enum Securegcm_InvocationReason: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
...
enum Securegcm_Type: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
  case enrollment = 0
  case tickle = 1
  case txRequest = 2
  case txReply = 3
...
struct Securegcm_GcmDeviceInfo: @unchecked Sendable {
...
struct Securegcm_GcmMetadata: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Securegcm_Tickle: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Securegcm_LoginNotificationInfo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Securegcm_AppleDeviceDiagonalMils: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}`>APPLE_PHONE\0\u{2}|<APPLE_PAD\0")
}

extension Securegcm_DeviceType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN\0\u{1}ANDROID\0\u{1}CHROME\0\u{1}IOS\0\u{1}BROWSER\0\u{1}OSX\0")
}

extension Securegcm_SoftwareFeature: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN_FEATURE\0\u{1}BETTER_TOGETHER_HOST\0\u{1}BETTER_TOGETHER_CLIENT\0\u{1}EASY_UNLOCK_HOST\0\u{1}EASY_UNLOCK_CLIENT\0\u{1}MAGIC_TETHER_HOST\0\u{1}MAGIC_TETHER_CLIENT\0\u{1}SMS_CONNECT_HOST\0\u{1}SMS_CONNECT_CLIENT\0")
}

extension Securegcm_InvocationReason: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0REASON_UNKNOWN\0\u{1}REASON_INITIALIZATION\0\u{1}REASON_PERIODIC\0\u{1}REASON_SLOW_PERIODIC\0\u{1}REASON_FAST_PERIODIC\0\u{1}REASON_EXPIRATION\0\u{1}REASON_FAILURE_RECOVERY\0\u{1}REASON_NEW_ACCOUNT\0\u{1}REASON_CHANGED_ACCOUNT\0\u{1}REASON_FEATURE_TOGGLED\0\u{1}REASON_SERVER_INITIATED\0\u{1}REASON_ADDRESS_CHANGE\0\u{1}REASON_SOFTWARE_UPDATE\0\u{1}REASON_MANUAL\0\u{1}REASON_CUSTOM_KEY_INVALIDATION\0\u{1}REASON_PROXIMITY_PERIODIC\0")
}

extension Securegcm_Type: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0ENROLLMENT\0\u{1}TICKLE\0\u{1}TX_REQUEST\0\u{1}TX_REPLY\0\u{1}TX_SYNC_REQUEST\0\u{1}TX_SYNC_RESPONSE\0\u{1}TX_PING\0\u{1}DEVICE_INFO_UPDATE\0\u{1}TX_CANCEL_REQUEST\0\u{2}\u{2}PROXIMITYAUTH_PAIRING\0\u{1}GCMV1_IDENTITY_ASSERTION\0\u{1}DEVICE_TO_DEVICE_RESPONDER_HELLO_PAYLOAD\0\u{1}DEVICE_TO_DEVICE_MESSAGE\0\u{1}DEVICE_PROXIMITY_CALLBACK\0\u{1}UNLOCK_KEY_SIGNED_CHALLENGE\0\u{2}V\u{1}LOGIN_NOTIFICATION\0")
}
...
extension Securegcm_GcmDeviceInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}android_device_id\0\u{4}\u{3}user_public_key\0\u{4}\u{3}device_model\0\u{1}locale\0\u{3}key_handle\0\u{2}\u{3}counter\0\u{3}device_os_version\0\u{3}device_os_version_code\0\u{3}device_os_release\0\u{3}device_os_codename\0\u{3}device_software_version\0\u{3}device_software_version_code\0\u{3}device_software_package\0\u{4}\u{3}device_display_diagonal_mils\0\u{4}\u{2}device_authzen_version\0\u{4}\u{5}long_device_id\0\u{4}\u{2}device_manufacturer\0\u{3}device_type\0\u{4}F\u{1}gcm_registration_id\0\u{3}device_master_key_hash\0\u{4}c\u{1}apn_registration_id\0\u{3}notification_enabled\0\u{4}c\u{1}bluetooth_mac_address\0\u{4}b\u{1}using_secure_screenlock\0\u{3}auto_unlock_screenlock_supported\0\u{3}auto_unlock_screenlock_enabled\0\u{3}bluetooth_radio_supported\0\u{3}bluetooth_radio_enabled\0\u{3}mobile_data_supported\0\u{3}tethering_supported\0\u{3}ble_radio_supported\0\u{3}pixel_experience\0\u{3}arc_plus_plus\0\u{3}is_screenlock_state_flaky\0\u{3}supported_software_features\0\u{3}enabled_software_features\0\u{4}L\u{9}enrollment_session_id\0\u{3}oauth_token\0")
...
extension Securegcm_GcmMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}type\0\u{1}version\0")
...
extension Securegcm_Tickle: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}expiry_time\0")
...
extension Securegcm_LoginNotificationInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{4}\u{2}creation_time\0\u{1}email\0\u{1}host\0\u{1}source\0\u{3}event_type\0")
