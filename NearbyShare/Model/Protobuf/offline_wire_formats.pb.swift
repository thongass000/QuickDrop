...
enum Location_Nearby_Connections_EndpointType: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
...
struct Location_Nearby_Connections_OfflineFrame: Sendable {
...
struct Location_Nearby_Connections_V1Frame: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Location_Nearby_Connections_ConnectionRequestFrame: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// Represents the {@link Device} that invokes the request.
  enum OneOf_Device: Equatable, Sendable {
  ...
  /// LINT.IfChange
  enum Medium: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  /// LINT.IfChange
  enum ConnectionMode: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
    case legacy = 0
    case instant = 1
...
struct Location_Nearby_Connections_ConnectionResponseFrame: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Location_Nearby_Connections_PayloadTransferFrame: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  enum PacketType: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  struct ControlMessage: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    enum EventType: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
...
struct Location_Nearby_Connections_BandwidthUpgradeNegotiationFrame: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  struct UpgradePathInfo: @unchecked Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    struct WifiHotspotCredentials: Sendable {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
    ...
    struct BluetoothCredentials: Sendable {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
    ...
    struct WifiAwareCredentials: Sendable {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
    ...
    struct WifiDirectCredentials: Sendable {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
    ...
    struct WebRtcCredentials: Sendable {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
    ...
    struct AwdlCredentials: Sendable {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
    ...
    struct UpgradePathRequest: Sendable {
      // SwiftProtobuf.Message conformance is added in an extension below. See the
      // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
      // methods supported on all messages.
  ...
  struct SafeToClosePriorChannel: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  struct ClientIntroduction: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  struct ClientIntroductionAck: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
struct Location_Nearby_Connections_BandwidthUpgradeRetryFrame: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Location_Nearby_Connections_KeepAliveFrame: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Location_Nearby_Connections_DisconnectionFrame: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Location_Nearby_Connections_PairedKeyEncryptionFrame: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Location_Nearby_Connections_AuthenticationMessageFrame: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Location_Nearby_Connections_AuthenticationResultFrame: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Location_Nearby_Connections_AutoResumeFrame: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Location_Nearby_Connections_AutoReconnectFrame: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Location_Nearby_Connections_MediumMetadata: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Available channels on the local device.
struct Location_Nearby_Connections_AvailableChannels: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Usable WiFi Direct client channels on the local device.
struct Location_Nearby_Connections_WifiDirectCliUsableChannels: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Usable WiFi LAN channels on the local device.
struct Location_Nearby_Connections_WifiLanUsableChannels: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Usable WiFi Aware channels on the local device.
struct Location_Nearby_Connections_WifiAwareUsableChannels: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Usable WiFi Hotspot STA channels on the local device.
struct Location_Nearby_Connections_WifiHotspotStaUsableChannels: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// The medium roles.
struct Location_Nearby_Connections_MediumRole: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Location_Nearby_Connections_LocationHint: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Location_Nearby_Connections_LocationStandard: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  enum Format: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
    case unknown = 0
...
struct Location_Nearby_Connections_OsInfo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Location_Nearby_Connections_ConnectionsDevice: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Location_Nearby_Connections_PresenceDevice: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  enum DeviceType: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
    case unknown = 0
    case phone = 1
    case tablet = 2
    case display = 3
...
extension Location_Nearby_Connections_EndpointType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN_ENDPOINT\0\u{1}CONNECTIONS_ENDPOINT\0\u{1}PRESENCE_ENDPOINT\0")
}
...
extension Location_Nearby_Connections_V1Frame: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}type\0\u{3}connection_request\0\u{3}connection_response\0\u{3}payload_transfer\0\u{3}bandwidth_upgrade_negotiation\0\u{3}keep_alive\0\u{1}disconnection\0\u{3}paired_key_encryption\0\u{3}authentication_message\0\u{3}authentication_result\0\u{3}auto_resume\0\u{3}auto_reconnect\0\u{3}bandwidth_upgrade_retry\0")
...
extension Location_Nearby_Connections_V1Frame.FrameType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN_FRAME_TYPE\0\u{1}CONNECTION_REQUEST\0\u{1}CONNECTION_RESPONSE\0\u{1}PAYLOAD_TRANSFER\0\u{1}BANDWIDTH_UPGRADE_NEGOTIATION\0\u{1}KEEP_ALIVE\0\u{1}DISCONNECTION\0\u{1}PAIRED_KEY_ENCRYPTION\0\u{1}AUTHENTICATION_MESSAGE\0\u{1}AUTHENTICATION_RESULT\0\u{1}AUTO_RESUME\0\u{1}AUTO_RECONNECT\0\u{1}BANDWIDTH_UPGRADE_RETRY\0")
}
...
extension Location_Nearby_Connections_ConnectionRequestFrame.Medium: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN_MEDIUM\0\u{1}MDNS\0\u{1}BLUETOOTH\0\u{1}WIFI_HOTSPOT\0\u{1}BLE\0\u{1}WIFI_LAN\0\u{1}WIFI_AWARE\0\u{1}NFC\0\u{1}WIFI_DIRECT\0\u{1}WEB_RTC\0\u{1}BLE_L2CAP\0\u{1}USB\0\u{1}WEB_RTC_NON_CELLULAR\0\u{1}AWDL\0")
}

extension Location_Nearby_Connections_ConnectionRequestFrame.ConnectionMode: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0LEGACY\0\u{1}INSTANT\0")
}
...
extension Location_Nearby_Connections_ConnectionResponseFrame: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}status\0\u{3}handshake_data\0\u{1}response\0\u{3}os_info\0\u{3}multiplex_socket_bitmask\0\u{3}nearby_connections_version\0\u{3}safe_to_disconnect_version\0\u{3}location_hint\0\u{3}keep_alive_timeout_millis\0")
...
extension Location_Nearby_Connections_ConnectionResponseFrame.ResponseStatus: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN_RESPONSE_STATUS\0\u{1}ACCEPT\0\u{1}REJECT\0")
}
...
extension Location_Nearby_Connections_PayloadTransferFrame: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}packet_type\0\u{3}payload_header\0\u{3}payload_chunk\0\u{3}control_message\0")
...
extension Location_Nearby_Connections_PayloadTransferFrame.PacketType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN_PACKET_TYPE\0\u{1}DATA\0\u{1}CONTROL\0\u{1}PAYLOAD_ACK\0")
}
...
extension Location_Nearby_Connections_PayloadTransferFrame.PayloadHeader: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}type\0\u{3}total_size\0\u{3}is_sensitive\0\u{3}file_name\0\u{3}parent_folder\0\u{3}last_modified_timestamp_millis\0")
...
extension Location_Nearby_Connections_PayloadTransferFrame.PayloadHeader.PayloadType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN_PAYLOAD_TYPE\0\u{1}BYTES\0\u{1}FILE\0\u{1}STREAM\0")
}
...
extension Location_Nearby_Connections_PayloadTransferFrame.PayloadChunk: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}flags\0\u{1}offset\0\u{1}body\0\u{1}index\0")
...
extension Location_Nearby_Connections_PayloadTransferFrame.PayloadChunk.Flags: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}LAST_CHUNK\0")
}
...
extension Location_Nearby_Connections_PayloadTransferFrame.ControlMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}event\0\u{1}offset\0")
...
extension Location_Nearby_Connections_PayloadTransferFrame.ControlMessage.EventType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN_EVENT_TYPE\0\u{1}PAYLOAD_ERROR\0\u{1}PAYLOAD_CANCELED\0\u{1}PAYLOAD_RECEIVED_ACK\0")
}
...
extension Location_Nearby_Connections_BandwidthUpgradeNegotiationFrame: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}event_type\0\u{3}upgrade_path_info\0\u{3}client_introduction\0\u{3}client_introduction_ack\0\u{3}safe_to_close_prior_channel\0")
...
extension Location_Nearby_Connections_BandwidthUpgradeNegotiationFrame.EventType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN_EVENT_TYPE\0\u{1}UPGRADE_PATH_AVAILABLE\0\u{1}LAST_WRITE_TO_PRIOR_CHANNEL\0\u{1}SAFE_TO_CLOSE_PRIOR_CHANNEL\0\u{1}CLIENT_INTRODUCTION\0\u{1}UPGRADE_FAILURE\0\u{1}CLIENT_INTRODUCTION_ACK\0\u{1}UPGRADE_PATH_REQUEST\0")
}
...
extension Location_Nearby_Connections_BandwidthUpgradeNegotiationFrame.UpgradePathInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}medium\0\u{3}wifi_hotspot_credentials\0\u{3}wifi_lan_socket\0\u{3}bluetooth_credentials\0\u{3}wifi_aware_credentials\0\u{3}wifi_direct_credentials\0\u{3}supports_disabling_encryption\0\u{3}web_rtc_credentials\0\u{3}supports_client_introduction_ack\0\u{3}upgrade_path_request\0\u{3}awdl_credentials\0")
...
extension Location_Nearby_Connections_BandwidthUpgradeNegotiationFrame.UpgradePathInfo.Medium: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN_MEDIUM\0\u{1}MDNS\0\u{1}BLUETOOTH\0\u{1}WIFI_HOTSPOT\0\u{1}BLE\0\u{1}WIFI_LAN\0\u{1}WIFI_AWARE\0\u{1}NFC\0\u{1}WIFI_DIRECT\0\u{1}WEB_RTC\0\u{2}\u{2}USB\0\u{1}WEB_RTC_NON_CELLULAR\0\u{1}AWDL\0")
}
...
extension Location_Nearby_Connections_BandwidthUpgradeNegotiationFrame.UpgradePathInfo.WifiHotspotCredentials: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}ssid\0\u{1}password\0\u{1}port\0\u{1}gateway\0\u{1}frequency\0")
...
extension Location_Nearby_Connections_BandwidthUpgradeNegotiationFrame.UpgradePathInfo.WifiLanSocket: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}ip_address\0\u{3}wifi_port\0")
...
extension Location_Nearby_Connections_BandwidthUpgradeNegotiationFrame.UpgradePathInfo.BluetoothCredentials: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}service_name\0\u{3}mac_address\0")
...
extension Location_Nearby_Connections_BandwidthUpgradeNegotiationFrame.UpgradePathInfo.WifiAwareCredentials: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}service_id\0\u{3}service_info\0\u{1}password\0")
...
extension Location_Nearby_Connections_BandwidthUpgradeNegotiationFrame.UpgradePathInfo.WifiDirectCredentials: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}ssid\0\u{1}password\0\u{1}port\0\u{1}frequency\0\u{1}gateway\0\u{3}ip_v6_address\0")
...
extension Location_Nearby_Connections_BandwidthUpgradeNegotiationFrame.UpgradePathInfo.WebRtcCredentials: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}peer_id\0\u{3}location_hint\0")
...
extension Location_Nearby_Connections_BandwidthUpgradeNegotiationFrame.UpgradePathInfo.AwdlCredentials: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}service_name\0\u{3}service_type\0\u{1}password\0")
...
extension Location_Nearby_Connections_BandwidthUpgradeNegotiationFrame.UpgradePathInfo.UpgradePathRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}mediums\0\u{3}medium_meta_data\0")
...
extension Location_Nearby_Connections_BandwidthUpgradeNegotiationFrame.SafeToClosePriorChannel: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}sta_frequency\0")
...
extension Location_Nearby_Connections_BandwidthUpgradeNegotiationFrame.ClientIntroduction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}endpoint_id\0\u{3}supports_disabling_encryption\0\u{3}last_endpoint_id\0")
...
extension Location_Nearby_Connections_BandwidthUpgradeRetryFrame: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}supported_medium\0\u{3}is_request\0")
...
extension Location_Nearby_Connections_BandwidthUpgradeRetryFrame.Medium: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN_MEDIUM\0\u{2}\u{2}BLUETOOTH\0\u{1}WIFI_HOTSPOT\0\u{1}BLE\0\u{1}WIFI_LAN\0\u{1}WIFI_AWARE\0\u{1}NFC\0\u{1}WIFI_DIRECT\0\u{1}WEB_RTC\0\u{1}BLE_L2CAP\0\u{1}USB\0\u{1}WEB_RTC_NON_CELLULAR\0\u{1}AWDL\0")
}
...
extension Location_Nearby_Connections_KeepAliveFrame: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}ack\0\u{3}seq_num\0")
...
extension Location_Nearby_Connections_DisconnectionFrame: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}request_safe_to_disconnect\0\u{3}ack_safe_to_disconnect\0")
...
extension Location_Nearby_Connections_PairedKeyEncryptionFrame: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}signed_data\0")
...
extension Location_Nearby_Connections_AuthenticationMessageFrame: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}auth_message\0")
...
extension Location_Nearby_Connections_AutoResumeFrame: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}event_type\0\u{3}pending_payload_id\0\u{3}next_payload_chunk_index\0\u{1}version\0")
...
extension Location_Nearby_Connections_AutoResumeFrame.EventType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN_AUTO_RESUME_EVENT_TYPE\0\u{1}PAYLOAD_RESUME_TRANSFER_START\0\u{1}PAYLOAD_RESUME_TRANSFER_ACK\0")
}
...
extension Location_Nearby_Connections_AutoReconnectFrame: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}endpoint_id\0\u{3}event_type\0\u{3}last_endpoint_id\0")
...
extension Location_Nearby_Connections_AutoReconnectFrame.EventType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN_EVENT_TYPE\0\u{1}CLIENT_INTRODUCTION\0\u{1}CLIENT_INTRODUCTION_ACK\0")
}
...
extension Location_Nearby_Connections_MediumMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}supports_5_ghz\0\u{1}bssid\0\u{3}ip_address\0\u{3}supports_6_ghz\0\u{3}mobile_radio\0\u{3}ap_frequency\0\u{3}available_channels\0\u{3}wifi_direct_cli_usable_channels\0\u{3}wifi_lan_usable_channels\0\u{3}wifi_aware_usable_channels\0\u{3}wifi_hotspot_sta_usable_channels\0\u{3}medium_role\0")
...
extension Location_Nearby_Connections_MediumRole: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}support_wifi_direct_group_owner\0\u{3}support_wifi_direct_group_client\0\u{3}support_wifi_hotspot_host\0\u{3}support_wifi_hotspot_client\0\u{3}support_wifi_aware_publisher\0\u{3}support_wifi_aware_subscriber\0\u{3}support_awdl_publisher\0\u{3}support_awdl_subscriber\0")
...
extension Location_Nearby_Connections_LocationHint: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}location\0\u{1}format\0")
...
extension Location_Nearby_Connections_LocationStandard.Format: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN\0\u{1}E164_CALLING\0\u{1}ISO_3166_1_ALPHA_2\0")
}
...
extension Location_Nearby_Connections_OsInfo.OsType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN_OS_TYPE\0\u{1}ANDROID\0\u{1}CHROME_OS\0\u{1}WINDOWS\0\u{1}APPLE\0\u{2}`\u{1}LINUX\0")
}
...
extension Location_Nearby_Connections_ConnectionsDevice: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}endpoint_id\0\u{3}endpoint_type\0\u{3}connectivity_info_list\0\u{3}endpoint_info\0")
...
extension Location_Nearby_Connections_PresenceDevice: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}endpoint_id\0\u{3}endpoint_type\0\u{3}connectivity_info_list\0\u{3}device_id\0\u{3}device_name\0\u{3}device_type\0\u{3}device_image_url\0\u{3}discovery_medium\0\u{1}actions\0\u{3}identity_type\0")
...
extension Location_Nearby_Connections_PresenceDevice.DeviceType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0UNKNOWN\0\u{1}PHONE\0\u{1}TABLET\0\u{1}DISPLAY\0\u{1}LAPTOP\0\u{1}TV\0\u{1}WATCH\0")
}
